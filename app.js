...
var studentObj01 = new Student("Sami", "sami@gmail.com", "karachi", "true");
console.log(studentObj01());

//  To make these Functions and Varialbe in String. So we use // For in loop // to make these variables and functions to string.
...
var mobiles = {
  ...
  for (var key in mobiles) {
    for (var innerKeys in mobiles[key]) {
        for (var innerInnerKeys in mobiles[key][innerKeys]) {
            for (var innerInnerinnerKeys in mobiles[key][innerKeys][innerInnerKeys]) {
                for (var innerInnerinnerInnerKeys in mobiles[key][innerKeys][innerInnerKeys][innerInnerinnerKeys]) {
                    for (var InnerinnerInnerinnerInnerKeys in mobiles[key][innerKeys][innerInnerKeys][innerInnerinnerKeys][innerInnerinnerInnerKeys]) {
                        console.log(mobiles[key][innerKeys][innerInnerKeys][innerInnerinnerKeys][innerInnerinnerInnerKeys][InnerinnerInnerinnerInnerKeys]);
                    }
                }
            }
        }
